...
* [1. DEX 与聚合交易器 (DEX & Aggregators)](#1-dex-与聚合交易器)
* [2. 链上数据与追踪 (On-chain Analytics)](#2-链上数据与追踪)
* [3. Web3 安全与审计 (Security & Audits)](#3-web3-安全与审计)
* [4. 量化与套利工具 (Quant & Arbitrage)](#4-量化与套利工具)
